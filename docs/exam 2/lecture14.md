...
- 8 Mar - Project Discussion, Stress-based Fatigue
- 10 Mar - Stress-based Fatigue, HW6 Due, HW5 Self-grade due 
- 15 Mar - (Spring Break)
- 17 Mar - (Spring Break)
- 22 Mar - Strain-based Fatigue
- 24 Mar - Crack Growth, HW7 Due, HW6 Self-grade due, Project Abstract Due
...
![](../images/p232-a.jpg) <!-- .element width="50%" -->
...
-   It is sometimes arbitrarily assigned using whatever the failure stress is at some large number of cycles (`$10^7$` or `$10^8$`)
...
-   "High cycle fatigue" generally is considered anything above 1000 cycles, but varies somewhat by material
